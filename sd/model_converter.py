...
class _PLStubFinder(importlib.abc.MetaPathFinder):
    """Auto-create stub modules for any pytorch_lightning.* import."""
    ...
    def load_module(self, fullname):
        ...
        mod.__path__ = []
        mod.__loader__ = self
        # Provide a dummy class for any attribute access (e.g. ModelCheckpoint)
...
if "pytorch_lightning" not in sys.modules:
    sys.meta_path.insert(0, _PLStubFinder())
